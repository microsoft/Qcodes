...
class Multi2DSetPointParam(MultiParameter):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        labels = ("this label", "that label")
        units = ("this unit", "that unit")
        sp_base_1 = tuple(np.linspace(5, 9, 5).tolist())
        sp_base_2 = tuple(np.linspace(9, 11, 3).tolist())
...
class Multi2DSetPointParam2Sizes(MultiParameter):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        labels = ("this label", "that label")
        units = ("this unit", "that unit")
        sp_base_1_1 = tuple(np.linspace(5, 9, 5).tolist())
        sp_base_2_1 = tuple(np.linspace(9, 11, 3).tolist())
        array_setpoints_1 = setpoint_generator(sp_base_1_1, sp_base_2_1)
        sp_base_1_2 = tuple(np.linspace(5, 9, 2).tolist())
        sp_base_2_2 = tuple(np.linspace(9, 11, 7).tolist())
