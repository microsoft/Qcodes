...
class AlazarTech_ATS9440(AlazarTech_ATS):
    ...
    def __init__(self, name, **kwargs):
        ...
        self.add_parameter(name='external_sample_rate',
                           ...
                           unit='S/s',
                           vals=validators.Enum(1000000, 125000000), #100MHz to 1Mhz
                           value=100000000)
        ...
        self.add_parameter(name='manual_sample_rate', #not in pdf
                           get_cmd=None,
                           set_cmd=None,
        ...
        self.add_parameter(name='decimation',
                           ...
                           unit=None,
                           value=1,
                           vals=validators.Ints(1, 100000)) #between 1-100000
...
#why is bwlimit not here?
        ...
        for i in ['1', '2','3', '4']: #only 1,2 and not 1,2,3,4?
            ...
            self.add_parameter(name='trigger_level' + i,
                               ...
                               unit=None,
                               value=140, #not sure what the value here should be
        ...
        self.add_parameter(name='external_trigger_coupling',
                           ...
                           unit=None,
                           value='DC',
                           byte_to_value_dict={1: 'AC', 2: 'DC'}) #9373 is defined differently here
