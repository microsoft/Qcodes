...
class AlazarATSAPI(WrappedDll):
    ...
    def set_trigger_time_out(
        self, handle: int, timeout_ticks: int | Parameter
    ) -> ReturnCode:
    ...
    def set_capture_clock(
        self,
        handle: int,
        source_id: int | Parameter,
        sample_rate_id_or_value: int | Parameter,
        edge_id: int | Parameter,
        decimation: int | Parameter,
    ) -> ReturnCode:
        return self._sync_dll_call(
    ...
    def input_control(
        self,
        handle: int,
        channel_id: int | Parameter,
        coupling_id: int | Parameter,
        range_id: int | Parameter,
        impedance_id: int | Parameter,
    ) -> ReturnCode:
        return self._sync_dll_call(
            "AlazarInputControl",
            handle,
    ...
    def set_bw_limit(
        self, handle: int, channel_id: int | Parameter, flag: int | Parameter
    ) -> ReturnCode:
    ...
    def set_trigger_operation(
        self,
        handle: int,
        trigger_operation: int | Parameter,
        trigger_engine_id_1: int | Parameter,
        source_id_1: int | Parameter,
        slope_id_1: int | Parameter,
        level_1: int | Parameter,
        trigger_engine_id_2: int | Parameter,
        source_id_2: int | Parameter,
        slope_id_2: int | Parameter,
        level_2: int | Parameter,
    ) -> ReturnCode:
        return self._sync_dll_call(
    ...
    def set_external_trigger(
        self, handle: int, coupling_id: int | Parameter, range_id: int | Parameter
    ) -> ReturnCode:
        return self._sync_dll_call(
    ...
    def set_trigger_delay(self, handle: int, value: int | Parameter) -> ReturnCode:
    ...
    def configure_aux_io(
        self,
        handle: int,
        mode_id: int | Parameter,
        mode_parameter_value: int | Parameter,
    ) -> ReturnCode:
        return self._sync_dll_call(
    ...
    def set_record_size(
        self,
        handle: int,
        pre_trigger_samples: int | Parameter,
        post_trigger_samples: int | Parameter,
    ) -> ReturnCode:
        return self._sync_dll_call(
