...
New:
____
- Keysight B1511B SMU driver has been added for support with the B1500 (#2278)
- Notebook: Example of how buffered sweep could be done on param with setpoints (#2263)


Improved:
_________
- Station: Take verbose error message when validating station yaml against schema (#2282)
- Add optional shape metadata to dataset (#2145)


Improved drivers:
_________________
- AMI430: `has_current_rating` has been removed in the driver to work with the new firmware version (#2291)
...
- Station example doc: update update_config_schema example to refer to qcodes_contrib_drivers (#2272)
- Fix some of the warnings triggered by numpy 1.19 (#2239)
- Fix sequence sorted check to work correctly with sequence types other than list (#2271)
- Move tests related to qcodes.data loop etc to a legacy folder (#2238)
- Legacy: ensure that datasets have unique names to avoid potential race condition (#2276) 
