...
class TestZIHDAWG8(unittest.TestCase):
    ...
    def test_generate_csv_sequence_program(self):
        expected = textwrap.dedent("""
                        ...
                        while(true){
                            playWaves(1, "wave_1", 2, "wave_2", 3, "wave_3");
                        }
                        """)
        sequence_program = ZIHDAWG8.generate_csv_sequence_program(['wave_1', 'wave_2', 'wave_3'], [1, 2, 3])
        self.assertEqual(expected, sequence_program)

    def test_generate_csv_sequence_program_no_channels(self):
        expected = textwrap.dedent("""
                        // generated by qcodes.instrument_drivers.ZI.ZIHDAWG8
    
                        while(true){
                            playWaves("wave_1", "wave_2", "wave_3");
                        }
                        """)
        sequence_program = ZIHDAWG8.generate_csv_sequence_program(['wave_1', 'wave_2', 'wave_3'])
        self.assertEqual(expected, sequence_program)

    def test_generate_csv_sequence_program_1_wave_no_channels(self):
        expected = textwrap.dedent("""
                        // generated by qcodes.instrument_drivers.ZI.ZIHDAWG8
                        ...
                        """)
        sequence_program = ZIHDAWG8.generate_csv_sequence_program(['wave_1'])
        self.assertEqual(expected, sequence_program)
