...
"""
NOTE (serwan): This is nearly an exact copy of the Infiniium driver,
but it had some minor issues when trying to use it for the Infiniium DS08104A.
This is likely due to the original Infiniium driver being written for another
Infiniium instrument, and so might have slightly different functionality.
Eventually the changes here should be included in the original Infiniium driver.
"""
...
class RawTrace(ArrayParameter):
    ...
    def get(self):
        ...
        if len(data) != self.shape[0]:
            print('{} points have been aquired and {} \
