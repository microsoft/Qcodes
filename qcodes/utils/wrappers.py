...
def init(mainfolder:str, sample_name: str):
    ...
    # else crash and burn
    # dirty hack to capture warning from IPYTHON
    ...
    if ipython is None:
        ...
        try:
            ipython.magic("%logstart -t {} {}".format(path_to_experiment_folder+"commands.log", "append"))
        except UserWarning:
            logging.debug("logging already started in current session and experiment")
