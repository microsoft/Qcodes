...
# seq mode 1, many shots
class HD_Filter_Acquisition_Controller(AcquisitionController):
    """Heterodyne Measurement Controller
    Mixes signal with demodulation frequency and then uses selected filter
    to filter double frequency componenet and return average
    """
    ...
    def handle_buffer(self, data):
        ...
        :return:
        """
        buffer_length = (self.samples_per_record *
                         self.records_per_buffer *
                         self.number_of_channels)
        i0 = self.buffer_count * buffer_length
        i1 = i0 + buffer_length
