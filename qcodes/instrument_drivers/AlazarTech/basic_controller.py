class Basic_AcquisitionController(AcquisitionController):
    ...
    primarily to check the function of the Alazar driver to do what it should and should be used 
    with one buffer and one record and will return each of the samples unprocessed
    ...
    **kwargs: kwargs are forwarded to the Instrument base class
    ...
    def post_acquire(self):
        ...
        if records_per_acquisition != 1:
            raise ValueError('records per acquisition and buffers per acquisition should be 
                set to 1 for this acquisition controller')
