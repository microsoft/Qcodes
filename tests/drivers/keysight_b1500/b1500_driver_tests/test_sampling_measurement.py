...
def test_compliance(smu_sampling_measurement, smu_output) -> None:
    ...
    smu_compliance = smu_sampling_measurement.sampling_measurement_trace.compliance()
...
def test_output_data_type_and_data_channel(
    ...
    data_channel = smu_sampling_measurement.sampling_measurement_trace.data.channel
