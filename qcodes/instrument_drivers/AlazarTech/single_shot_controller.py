...
class Single_Shot_Acquisition_Controller(AcquisitionController):
    """Heterodyne Measurement Controller
    Mixes signal with demodulation frequency and then uses selected filter to filter
    double frequency componenet
