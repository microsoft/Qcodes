...
class SR86x(VisaInstrument):
    ...
    def __init__(
        ...
        **kwargs: Unpack[VisaInstrumentKWArgs],
        ...
        # Aux input/output
        self.aux_in0 = self.add_parameter(
            "aux_in0",
            label="Aux input 0",
            get_cmd="OAUX? 0",
            get_parser=float,
        ...
        self.aux_out0 = self.add_parameter(
            "aux_out0",
            label="Aux output 0",
            get_cmd="AUXV? 0",
            get_parser=float,
        ...
        self.aux_in1 = self.add_parameter(
            "aux_in1",
            label="Aux input 1",
            get_cmd="OAUX? 1",
            get_parser=float,
        ...
        self.aux_out1 = self.add_parameter(
            "aux_out1",
            label="Aux output 1",
            get_cmd="AUXV? 1",
            get_parser=float,
        ...
        self.aux_in2 = self.add_parameter(
            "aux_in2",
            label="Aux input 2",
            get_cmd="OAUX? 2",
            get_parser=float,
        ...
        self.aux_out2 = self.add_parameter(
            "aux_out2",
            label="Aux output 2",
            get_cmd="AUXV? 2",
            get_parser=float,
        ...
        self.aux_in3 = self.add_parameter(
            "aux_in3",
            label="Aux input 3",
            get_cmd="OAUX? 3",
            get_parser=float,
        ...
        self.aux_out3 = self.add_parameter(
            "aux_out3",
            label="Aux output 3",
            get_cmd="AUXV? 3",
            get_parser=float,
        ...
        data_channel = SR86xDataChannel(self, "data_channel_1", "0", "DAT1", "green")

        data_channels.append(data_channel)
        self.data_channel_1 = self.add_submodule("data_channel_1", data_channel)

        data_channel = SR86xDataChannel(self, "data_channel_2", "1", "DAT2", "blue")

        data_channels.append(data_channel)
        self.data_channel_2 = self.add_submodule("data_channel_2", data_channel)

        data_channel = SR86xDataChannel(self, "data_channel_3", "2", "DAT3", "yellow")

        data_channels.append(data_channel)
        self.data_channel_3 = self.add_submodule("data_channel_3", data_channel)

        data_channel = SR86xDataChannel(self, "data_channel_4", "3", "DAT4", "orange")

        data_channels.append(data_channel)
        self.data_channel_4 = self.add_submodule("data_channel_4", data_channel)
