...
def abstract_instrument(klass: Type[InstrumentBase]) -> Type[InstrumentBase]:
    """
    ...
    class Abstract(_instrument_base_type):
        def __init_subclass__(cls: Type[InstrumentBase]) -> None:
            ...
            def __init_new__(self: InstrumentBase, *args: Any, **kwargs: Any) -> None:
                """
            ...
            cls.__init__ = __init_new__  # type: ignore
