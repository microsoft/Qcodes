...
class Stanford_Research_Systems_SR830(VisaInstrument):
    ...
    def __init__(self, name, address, **kwargs):
        ...
        # Input and filter
        self._input_config_to_n = {
            'a': 0,
            'a-b': 1,
            '1 mohm': 2,
            '100 mohm': 3,
        }
        self._n_to_input_config = {v: k for k, v in self._input_config_to_n.items()}
        ...
        self._volt_to_n = {2e-9:    0, 5e-9:    1, 10e-9:  2, 
        ...
        self._n_to_volt = {v: k for k, v in self._volt_to_n.items()}

        self._curr_to_n = {2e-15:    0, 5e-15:    1, 10e-15:  2, 
        ...
        self._n_to_curr = {v: k for k, v in self._curr_to_n.items()}
        ...
        self.add_parameter(name='sensitivity',
                           ...
                           vals=MultiType(Enum(*self._volt_to_n.keys()),
                                          Enum(*self._curr_to_n.keys())))
        ...
        self.input_config(self.input_config())
    ...
    def _get_input_config(self, s):
        return self._n_to_input_config[int(s)]
