...
class Plot(object):
    '''
    Plot x/y lines or x/y/z heatmap data
    ...
    kwargs: passed along to self.add() to add the first data trace
    '''
    def __init__(self, figsize=(12, 5), interval=1, subplots=(1, 1),
                 **kwargs):
    ...
    def add(self, updater=None, **kwargs):
        '''
        ...
        # TODO if we don't specify x (and/or y) take them from
        # y (or z) setpoints
