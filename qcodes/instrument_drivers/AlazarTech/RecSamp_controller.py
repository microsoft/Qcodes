...
class RecSampParam(Parameter):
    ...
    def update_acquisition_kwargs(self, **kwargs):
        ...
        if 'samples_per_record' and 'records_per_buffer' in kwargs:
            spts = kwargs['samples_per_record']
            ...
            raise ValueError(
                'records_per_buffer and samples_per_record must be specified')
...
class HD_RecSamp_Controller(AcquisitionController):
    """
    ...
    **kwargs: kwargs are forwarded to the Instrument base class
    ...
    def fit(self, rec):
        ...
        # convert to magnitude and phase data
        # data returned is (samples * records)
