...
def test_datasaver_1d(
    ...
    if n_points == n_points_expected:
        ...
        exp_msg = (
            "Tried to set data shape for {} in "
            "dataset {} "
        ...
        assert caplog.record_tuples[0] == (
            ...
            exp_level,
            exp_msg.format(
                DMM.v1.full_name, DMM.v1.full_name, n_points, n_points_expected
            ),
        )
        assert caplog.record_tuples[1] == (
            ...
            exp_level,
            exp_msg.format(
                DAC.ch1.full_name, DMM.v1.full_name, n_points, n_points_expected
            ),
        )
        ...
        for set_v_1 in np.linspace(0, 1, n_points_1):
            for set_v_2 in np.linspace(0, 1, n_points_2):
                datasaver.add_result(
                    (DAC.ch1, set_v_1), (DAC.ch2, set_v_2), (DMM.v1, DMM.v1())
                )
